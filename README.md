...
### ABOUT THIS PROJECT
#### This project was based on an old Kaggle competition in which my partner and I chose the American Express Default Prediction which would use a logistic regression for the predictive model.
